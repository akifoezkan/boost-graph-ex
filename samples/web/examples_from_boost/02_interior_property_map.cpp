...
// create a tag for our new property - step-0
// (define vertex property type)
...
void who_owes_who(EdgeIter first, EdgeIter last, const Graph& G)
{
  ...
  typedef typename property_map<Graph, vertex_first_name_t>::const_type NameMap;
  NameMap name = get(vertex_first_name, G);

  // NameType is strin as we set in step-1
